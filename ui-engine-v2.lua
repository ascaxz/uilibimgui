			...
			function window_data:AddTab(tab_name)
				...
				do -- Tab Elements
					...
					function tab_data:AddKeybind(keybind_name, callback, keybind_options)
						...
						local keybind_obj = Prefabs:FindFirstChild("Keybind"):Clone()
						local input = keybind_obj:FindFirstChild("Input")
						local title = keybind_obj:FindFirstChild("Title")
						keybind_obj.ZIndex = keybind_obj.ZIndex + (windows * 10)
						input.ZIndex = input.ZIndex + (windows * 10)
						input:GetChildren()[1].ZIndex = input:GetChildren()[1].ZIndex + (windows * 10)
						title.ZIndex = title.ZIndex + (windows * 10)

						keybind_obj.Parent = new_tab
						title.Text = "  " .. keybind_name
						keybind_obj.Size = UDim2.new(0, gNameLen(title) + 80, 0, 20)
						...
						return keybind_data, keybind_obj
					end
